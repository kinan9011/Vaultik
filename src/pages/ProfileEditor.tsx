      ...
      >
        ...
        >
          {SECTIONS.map((s) => (
            <div
              key={s.key}
              className={"v-nav-item" + (s.active ? " active" : "")}
            >
        ...
        <div className="v-body" style={{ padding: "24px 32px" }}>
          <div style={{ maxWidth: 640 }}>
            <div style={{ marginBottom: 24 }}>
              ...
              >
                Where snapshots are stored. The repository URL points to a
                restic-compatible backend, and the password encrypts every byte
                ...
                {[
                  ...
                  <div
                    ...
                    style={{
                      ...
                      border:
                        "1px solid " +
                        (b.active ? "var(--accent-line)" : "var(--border)"),
                      background: b.active
                        ? "var(--accent-soft)"
                        : "var(--surface)",
            ...
            <Field
              ...
              hint="Includes user, host, and path. Vaultik will not modify this format."
            >
              <div className="row">
                <input
                ...
                {[
                  ...
                  <div
                    ...
                    style={{
                      ...
                      border:
                        "1px solid " +
                        (m.active ? "var(--accent-line)" : "var(--border)"),
                      background: m.active
                        ? "var(--accent-soft)"
                        : "var(--surface)",
                      borderRadius: "var(--r-sm)",
            ...
            >
              ...
              <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
                <div style={{ flex: 1 }}>
                  ...
                  >
                    Remove a stale lock left by a crashed restic process. Use
                    only if you’re certain nothing is running.
                  </div>
                </div>
